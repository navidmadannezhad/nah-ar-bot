...
bot.use((0, conversations_1.createConversation)(conversations_2.getIntervalConversation));
bot.use((0, conversations_1.createConversation)(conversations_2.sendNoticeMsgConversation));
// register menus
bot.use(menus_1.ServiceControllerMenu);
bot.use(menus_1.ServiceSelectMenu);
